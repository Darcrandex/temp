...
import { ValueTextPlugin } from './custom-plugins/ValueText/ValueTextPlugin'
import { ChartViewNode } from './custom-plugins/ChartView/ChartViewNode'
import { ChartViewPlugin } from './custom-plugins/ChartView/ChartViewPlugin'
...
export default function Editor(): JSX.Element {
  ...
  const cellEditorConfig = {
    ...
    nodes: [...TableCellNodes, ValueTextNode, ChartViewNode],
    onError: (error: Error) => {
      throw error
    },
