...
import { INSERT_VALUE_TEXT } from '../../custom-plugins/ValueText/ValueTextPlugin'
import { INSERT_CHART_VIEW } from '../../custom-plugins/ChartView/ChartViewPlugin'
  ...
  return (
    <div className='toolbar'>
      ...
      <button
        disabled={!isEditable}
        onClick={() => {
          activeEditor.dispatchCommand(INSERT_VALUE_TEXT, '')
        }}
        className={'toolbar-item spaced ' + (isBold ? 'active' : '')}
        title='插入数值文本'
        type='button'
      ...
      <button
        disabled={!isEditable}
        onClick={() => {
          activeEditor.dispatchCommand(INSERT_CHART_VIEW, '')
        }}
        className={'toolbar-item spaced ' + (isBold ? 'active' : '')}
        title='插入图表'
        type='button'
